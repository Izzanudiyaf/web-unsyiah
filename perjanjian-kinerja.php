...
<html lang="en">
    <head>
        <title>Perjanjian Kinerja | Unsiyah</title>        
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 pt50">
                            <h1 class="brand-heading font-montserrat color-black" data-in-effect="fadeInDown"><strong>Perjanjian Kinerja</strong></h1>                           
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <p class="lead color-black text-justify" style="line-height: 30px;">
                            Perjanjian Kinerja (PK) adalah lembar atau dokumen yang berisikan penugasan dari pimpinan instansi yang lebih tinggi kepada pimpinan instansi yang lebih rendah untuk melaksanakan program atau kegiatan yang disertai dengan indikator kinerja. Melalui PK, terwujudlah komitmen penerima amanah dan kesepakatan antara penerima dan pemberi amanah atas kinerja terukur, tertentu, berdasarkan tugas, fungsi, dan wewenang serta sumber daya yang tersedia. Kinerja yang disepakati tidak dibatasi pada kinerja yang dihasilkan atas kegiatan tahun bersangkutan, tetapitermasuk kinerja (outcome) yang seharusnya terwujud akibat kegiatan tahun-tahun sebelumnya. Dengan demikian target kinerja yang diperjanjikan juga mencakup outcome yang dihasilkan dari kegiatan tahun-tahun sebelumnya, sehingga terwujud kesinambungan kinerja setiap tahunnya. <br>
                            Tujuan Penyusunan Perjanjian Kinerja adalah: <br>
                        </p>
                            <ol class="lead color-black text-justify" style="line-height: 30px;">
                                <li>Sebagai wujud nyata komitmen antara penerima dan pemberi amanah untuk meningkatkan integritas, akuntabilitas, transparansi, dan kinerja aparatur;</li>
                                <li>Menciptakan tliok ukur kinerja sebagai dasar evaluasi kinerja aparatur;</li>
                                <li>Sebagai dasar penilaian keberhasilan atau kegagalan pencapaian tujuan dan sasaran organisasi dan sebagai dasar pemberian penghargaan dan sanksi;</li>
                                <li>Sebagai dasar bagi pemberi amanah untuk melakukan monitoring, evaluasi dan supervisi atas perkembangan atau kemajuan kinerja penerima amanah;</li>
                                <li>Sebagai dasar dalam penetapan sasaran kinerja pegawai</li>
                            </ol>
                            <br>
                        <p class="lead color-black text-justify" style="line-height: 30px;">
                            Perjanjian Kinerja Universtias Syiah Kuala meliputi: <br>
                            <ol class="lead color-black text-justify" style="line-height: 30px;">
                                <li>Perjanjian Kinerja Rektor dengan Kementerian Keuangan, Kementerian Pendidikan dan Kebudayaan dan Kementerian RISTEK BRIN.</li>
                                <li>Perjanjian Kinerja Individual, Rektor dan Pimpinan Unit Kerja</li>
                            </ol>                            
                        </p>
                    </div>
                </div>
