...
<html lang="en">
    <head>
        <title>Rencana Strategis | Unsiyah</title>        
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 pt50">
                            <h1 class="brand-heading font-montserrat color-black" data-in-effect="fadeInDown"><strong>Rencana Strategis</strong></h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        Sebagai salah satu institusi pendidikan tinggi, Universitas Syiah Kuala Unsyiah rnemiliki fungsi yang sangat strategis dalam meningkatkan kualitas sumber daya manusia (SDM), baik untuk kebutuhan lokal, maupun nasional dan global. Terlebih Iagi ketika masyarakat Aceh mengaitkannya sebagai Universitas jantung Hati Rakyat Aceh, maka tanggungjawab tersebut terasa semakin berat. Dengan mengintegrasikan nilai-nilai universal, nasional, dan lokal, Unsyiah berkewajiban untuk melahirkan SDM yang memiliki keselarasan dalam pemenuhan kebutuhan IPTEK dan IMTAQ. Dengan demikian, pada akhirnya Unsyiah diharapkan mampu melahirkan SDM yang memiliki keseimbangan antara keduanya, yaitu SDM yang berkualitas, berbudi pekerti, menjunjung tinggi etika, estetika, serta berakhlak mulia. OIeh karena itu, dalam mewujudkan fungsi tersebut diperlukan langkah pengembangan konkrit, jelas, terarah, dan terukur yang dituangkan dalam sebuah Rencana Strategis Renstra Unsyiah.
                        </p>
                    </div>
                </div>
            </div>
