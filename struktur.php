                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 pt50">
                            <h1 class="brand-heading font-montserrat color-black" data-in-effect="fadeInDown"><strong>Pimpinan</strong></h1>                        
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="pt10 pb75">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <img src="assets/img/struktur.png" width="100%">
                    </div>
                    <div class="col-md-1"></div>
                </div>
            </div>
